...
export const candidateSchema = z.object({
  ...
  max_commute_km: optionalNumber,
  has_car: z.coerce.number().int().min(0).max(1).optional(),
  willing_to_relocate: z.coerce.number().int().min(0).max(1).optional(),
...
export const jobSchema = z.object({
  ...
  employment_type: optionalText(30),
  work_mode: z.enum(['onsite', 'hybrid', 'remote']).optional().default('onsite'),
